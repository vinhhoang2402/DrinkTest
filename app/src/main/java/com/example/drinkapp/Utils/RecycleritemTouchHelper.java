...
public class RecycleritemTouchHelper extends ItemTouchHelper.SimpleCallback{
    ...
    public void clearView(@NonNull RecyclerView recyclerView, @NonNull RecyclerView.ViewHolder viewHolder) {
        ...
        }else  if (viewHolder instanceof FavoriteAdapter.FavoriteViewHolder)
        {
    ...
    public void onSelectedChanged(@Nullable RecyclerView.ViewHolder viewHolder, int actionState) {
        if (viewHolder != null) {
            if (viewHolder instanceof CartAdapter.CartViewHolder) {
                View foregroundView = ((CartAdapter.CartViewHolder) viewHolder).view_background;
                getDefaultUIUtil().onSelected(foregroundView);
            }else  if (viewHolder instanceof FavoriteAdapter.FavoriteViewHolder) {
                View foregroundView = ((FavoriteAdapter.FavoriteViewHolder) viewHolder).view_background;
                getDefaultUIUtil().onSelected(foregroundView);
            }
        }
    }
